    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Index(Student stu)
        {
            ...
            var students = from s in db.Students
                           select s;
            if (!String.IsNullOrEmpty(stu.LastName))
            {
                students = students.Where(s => s.LastName.ToUpper().Contains(stu.LastName.ToUpper())
                                       || s.FirstMidName.ToUpper().Contains(stu.FirstMidName.ToUpper()));
            } 
            //switch (sortOrder)
            //{
            //    case "Name_desc":
